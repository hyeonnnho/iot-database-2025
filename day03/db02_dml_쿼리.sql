-- INSERT
-- 3-44 : Book 테이블에 '스포츠 의학' 도서를 추가하세요. 한솔의학서적에서 출간, 가격은 90,000원입니다.
...
-- 다중 데이터 입력
INSERT INTO Book (bookid, bookname, publisher, price)
VALUE (13, '기타교본 1', '지미 핸드릭스', 12000),
	  (14, '기타교본 1', '지미 핸드릭스', 12000),
      (15, '기타교본 1', '지미 핸드릭스', 12000);
...
CREATE TABLE NewBook (
	bookid 		INTEGER PRIMARY KEY AUTO_INCREMENT, -- AUTO_INCREMENT : 숫자 자동 증가 조건
...
-- 3-50 : NewBook 의 모든 데이터를 삭제하시오.
-- WHERE 절로 필요한 데이터만 삭제하세요.
DELETE FROM NewBook;
