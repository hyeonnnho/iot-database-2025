...
BEGIN
	...
	DECLARE CONTINUE handler
			FOR NOT FOUND SET endOrRow = TRUE;
	-- 커서 오픈
    OPEN InterestCursor;
    cursor_loop : LOOP
		FETCH InterestCursor INTO price; -- select salprice from Orders 의 테이블 한 행씩 읽어서 값을 price에 집어넣는다.
        IF endOrRow THEN LEAVE cursor_loop; -- python break
        END IF;
